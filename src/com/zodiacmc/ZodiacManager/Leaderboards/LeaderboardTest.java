...
class LeaderboardTest {
    ...
    public static void main(String[] args) {
        ...
        // Test the HashMapLeaderboard class.
        testHashMapLeaderbaord();
    }
    ...
    static boolean test(ILeaderboard<String, Integer> lb) {
        ...
        if ((!rm1.getKey().equals("Toaster") && rm1.getValue() != -16)
                ...
                || (!rm3.getKey().equals("1337") && rm3.getValue() != 80) || (rm4 != null)) {
        ...
        if ((!ge1.getKey().equals("FooBar") && ge1.getValue() != 96)
                || (!ge2.getKey().equals("PajamaMan") && ge2.getValue() != 32) || (ge3 != null)) {
    ...
    public static void testHashMapLeaderbaord() {
        HashMapLeaderboard<String, Integer> lb = new HashMapLeaderboard<>();
        ...
        lb.sort(new Comparator<Map.Entry<String, Integer>>() {
        ...
        lb.keyConstraint = null;
        lb.valueConstraint = t -> {
            return t >= 0;
        };
        ...
        lb.clear();
        lb.load("reichman2: 21345623\nTomCrawley_: 465645\nCrossover_Lucky: 6355432");
        System.out.println(lb);
    }
